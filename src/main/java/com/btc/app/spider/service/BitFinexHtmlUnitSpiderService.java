...
public class BitFinexHtmlUnitSpiderService extends BasicHtmlUnitSpiderService {
    private CoinService coinService;
    private BitFinexHtmlUnitSpider spider;
    private final String URL;
    public static final String BITFINEX_URL = "https://www.bitfinex.com/stats";
    private SystemStatistics statistics;

    public BitFinexHtmlUnitSpiderService(CoinService service, String url) throws Exception {
        this.URL = url;
    ...
    public void run() {
        ...
        try {
            ...
            spider = new BitFinexHtmlUnitSpider(this.URL);
