...
public class CoinMarketCapHtmlUnitSpiderService extends BasicHtmlUnitSpiderService {
    private CoinService coinService;
    private CoinMarketCapHtmlUnitSpider spider;
    private final String URL;
    public static final String FXH_URL = "http://www.feixiaohao.com/all/#CNY";
    private SystemStatistics statistics;

    public CoinMarketCapHtmlUnitSpiderService(CoinService service, String url) throws Exception {
        this.URL = url;
    ...
    public void run() {
        ...
        try {
            ...
            spider = new CoinMarketCapHtmlUnitSpider(this.URL);
