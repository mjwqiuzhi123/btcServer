...
public class WeiboHttpSpiderService extends BasicHtmlUnitSpiderService {
    private WeiboService weiboService;
    private WeiboHttpSpider spider;
    private final String WEIBO_ID;//1839109034
    private final String WEIBO_URL;
    private SystemStatistics statistics;

    public WeiboHttpSpiderService(WeiboService service, String wbid) {
    ...
    public void run() {
        ...
        try {
            ...
            spider = new WeiboHttpSpider(WEIBO_ID);
            spider.parseHtml();
