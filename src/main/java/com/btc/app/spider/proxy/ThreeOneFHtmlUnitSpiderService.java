...
public class ThreeOneFHtmlUnitSpiderService extends BasicHtmlUnitSpiderService {
    private ThreeOneFHtmlUnitSpider spider;
    private final String URL;
    private BlockingQueue<ProxyBean> inQueue;

    public ThreeOneFHtmlUnitSpiderService(BlockingQueue<ProxyBean> inQueue, String url) {
        this.URL = url;
    ...
    public void run() {
        ...
        ProxyBean bean = null;
        try {
            spider = new ThreeOneFHtmlUnitSpider(inQueue,URL);
