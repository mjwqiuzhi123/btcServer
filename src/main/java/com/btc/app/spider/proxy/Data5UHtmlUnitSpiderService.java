...
public class Data5UHtmlUnitSpiderService extends BasicHtmlUnitSpiderService {
    private Data5UHtmlUnitSpider spider;
    private final String URL;
    private BlockingQueue<ProxyBean> inQueue;

    public Data5UHtmlUnitSpiderService(BlockingQueue<ProxyBean> inQueue, String url) {
        this.URL = url;
    ...
    public void run() {
        ...
        ProxyBean bean = null;
        try {
            spider = new Data5UHtmlUnitSpider(inQueue,URL);
