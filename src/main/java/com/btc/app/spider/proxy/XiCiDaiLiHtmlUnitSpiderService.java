...
public class XiCiDaiLiHtmlUnitSpiderService extends BasicHtmlUnitSpiderService {
    private XiCiDaiLiHtmlUnitSpider spider;
    private final String URL;
    private BlockingQueue<ProxyBean> inQueue;

    public XiCiDaiLiHtmlUnitSpiderService(BlockingQueue<ProxyBean> inQueue, String url) {
        this.URL = url;
    ...
    public void run() {
        ...
        ProxyBean bean = null;
        try {
            spider = new XiCiDaiLiHtmlUnitSpider(inQueue,URL);
